...
is
   ...
   begin
      ...
      if Fd = Session.Dispatch_Fd then
         ...
         Gneiss_Internal.Client.Dispatch (Session.Dispatch_Fd, Gneiss_Protocol.Message,
                                          Name, Label, Fds);
         Dispatch (Session,
   ...
   begin
      ...
      Gneiss_Internal.Client.Register (Session.Broker_Fd, Gneiss_Protocol.Message, Session.Dispatch_Fd);
      if Gneiss_Internal.Valid (Session.Dispatch_Fd) then
