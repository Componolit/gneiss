...
package Cai.Block.Server is
   ...
   procedure Initialize (D : in out Component.Block_Server_Device; L : String; C : Context);

   procedure Finalize (D : in out Component.Block_Server_Device);

   function Block_Count (D : in out Component.Block_Server_Device) return Count;

   function Block_Size (D : in out Component.Block_Server_Device) return Size;

   function Writable (D : in out Component.Block_Server_Device) return Boolean;

   function Maximal_Transfer_Size (D : in out Component.Block_Server_Device) return Unsigned_Long;
