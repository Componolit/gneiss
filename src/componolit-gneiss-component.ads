...
--
--  This file is part of Gneiss, which is distributed under the
...
generic
   ...
   with procedure Component_Construct
      (Capability : Componolit.Gneiss.Types.Capability);

   --  Component destruction procedure
   --  This procedure is called after Vacate has been called and the
   --  procedure Vacate has been called from returned.
