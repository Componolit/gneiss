...
with Interfaces;
with Componolit.Gneiss.Muchannel_Writer;
with Componolit.Gneiss.Muchannel_Reader;
with Muchannel_Constants;

package Componolit.Gneiss.Muen_Block with
   SPARK_Mode
is
   ...
   package Client_Request_Channel is new Componolit.Gneiss.Muchannel_Writer
      (Element_Type => Event,
   ...
   package Client_Response_Channel is new Componolit.Gneiss.Muchannel_Reader
      (Element_Type => Event,
       Elements     => Element_Count,
       Null_Element => Null_Event,
   ...
   package Server_Request_Channel is new Componolit.Gneiss.Muchannel_Reader
      (Element_Type => Event,
       Elements     => Element_Count,
       Null_Element => Null_Event,
       Protocol     => 16#9570_208d_ca77_db19#,
   ...
   package Server_Response_Channel is new Componolit.Gneiss.Muchannel_Writer
      (Element_Type => Event,
       Elements     => Element_Count,
       Null_Element => Null_Event,
       Protocol     => 16#9851_be32_82fe_f0dc#,
...
end Componolit.Gneiss.Muen_Block;
