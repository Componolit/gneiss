...
package Componolit.Gneiss.Block with
   SPARK_Mode
is
...
private
   ...
   type Client_Session is new Componolit.Gneiss.Internal.Block.Client_Session;
   type Dispatcher_Session is new Componolit.Gneiss.Internal.Block.Dispatcher_Session;
   type Server_Session is new Componolit.Gneiss.Internal.Block.Server_Session;
   type Dispatcher_Capability is new Componolit.Gneiss.Internal.Block.Dispatcher_Capability;
