...
is
   ...
   function Kind (R : Request) return Request_Kind is
      (case R.Kind is
          when Componolit.Gneiss.Internal.Block.Read  => Read,
          when Componolit.Gneiss.Internal.Block.Write => Write,
          when Componolit.Gneiss.Internal.Block.Sync  => Sync,
          when Componolit.Gneiss.Internal.Block.Trim  => Trim,
          when others                                     => None);
   ...
   begin
      case K is
         when None      => R.Kind := Componolit.Gneiss.Internal.Block.None;
         when Read      => R.Kind := Componolit.Gneiss.Internal.Block.Read;
         when Write     => R.Kind := Componolit.Gneiss.Internal.Block.Write;
         when Sync      => R.Kind := Componolit.Gneiss.Internal.Block.Sync;
         when Trim      => R.Kind := Componolit.Gneiss.Internal.Block.Trim;
         when Undefined => R.Kind := Componolit.Gneiss.Internal.Block.None;
      end case;
   ...
   begin
      case R.Kind is
         when Componolit.Gneiss.Internal.Block.Read =>
            Read (C, Request_Id'Val (R.Tag), Data);
         when Componolit.Gneiss.Internal.Block.Write =>
