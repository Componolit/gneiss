...
package Componolit.Interfaces.Internal.Block is
   ...
   Submitted    : constant Request_Status := 2;
   Pending      : constant Request_Status := 3;
   Finished     : constant Request_Status := 4;
   Ok           : constant Request_Status := 5;
   Error        : constant Request_Status := 6;
