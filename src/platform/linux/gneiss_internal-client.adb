...
is
   ...
   begin
      Fd := -1;
      Socket.Send (Broker_Fd, Gneiss_Protocol.Register, Kind, Name, Label, (1 .. 0 => -1));
   ...
   begin
      ...
      Socket.Send (Broker_Fd, Gneiss_Protocol.Request, Kind, Name, Lbl, Fds (Fds'First .. Last));
      Socket.Receive (Broker_Fd, Msg, Fds, True);
   ...
   begin
      ...
      Socket.Send (Fd, Gneiss_Protocol.Confirm, Kind, S_Name, S_Label, Fds);
   end Confirm;
   ...
   begin
      ...
      S_Label.Last := S_Label.Value'First + Label'Last - 1;
      S_Label.Value (S_Label.Value'First .. S_Label.Last) := Label;
      Socket.Send (Fd, Gneiss_Protocol.Reject, Kind, S_Name, S_Label, (1 .. 0 => -1));
   end Reject;
