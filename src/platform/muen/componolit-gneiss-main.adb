...
package body Componolit.Gneiss.Main with
   SPARK_Mode
is
   ...
   is
      ...
      use type CIM.Status;
      Null_Cap : constant Componolit.Gneiss.Internal.Types.Capability := (null record);
      function Gen_Cap is new Ada.Unchecked_Conversion (Componolit.Gneiss.Internal.Types.Capability,
                                                        Componolit.Gneiss.Types.Capability);
