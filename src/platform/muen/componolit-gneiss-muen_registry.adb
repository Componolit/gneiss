...
with Componolit.Gneiss.Internal.Block;

package body Componolit.Gneiss.Muen_Registry with
   SPARK_Mode
is
   ...
   is
      Session : Componolit.Gneiss.Internal.Block.Dispatcher_Session with
         Import,
         Address => S.Session;
      procedure Event (D : Componolit.Gneiss.Internal.Block.Dispatcher_Session) with
         Import,
